...
Under «endre» → «Flere innstillinger» legger du inn lenker til kontraktsmal, ansvarsbegrensning og rutinen, så vises de i oppstartssjekken på første runde. Oppstartssjekken kan settes til «følg opp neste runde», som lager et tiltak og kommer igjen måneden etter. Med leders e-post får du knappen «Send e-post til leder» med deg selv på kopi, i tillegg til Teams-chat.
